import svgPaths from "./svg-5b7dndtdzq";
  ...
  return (
    <div className="h-[32px] relative shrink-0 w-[20.672px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start relative size-full">
        <p className="font-['Inter:Regular','Noto_Sans:Regular',sans-serif] font-normal leading-[32px] not-italic relative shrink-0 text-[#00a5a8] text-[24px] text-center whitespace-nowrap">◉</p>
      </div>
    </div>
  );
}
