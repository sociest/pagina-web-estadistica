function StudentsInternshipsHeroSection({ hero }) {
  const LeftShape = hero.leftShape
  const RightShape = hero.rightShape

  return (
    <section className="relative overflow-hidden border-b-[8px] border-[#ea580c] bg-[#001d3d] px-8 pb-24 pt-[140px]">
      ...
      <svg className="absolute inset-0 h-full w-full opacity-[0.1]" viewBox="0 0 1600 620" preserveAspectRatio="none" fill="none" aria-hidden="true">
        <path d="M0 420C320 420 640 260 960 220C1170 194 1390 220 1600 420" stroke="#ea580c" strokeWidth="2.3" />
        <path d="M0 454C320 454 640 294 960 254C1170 228 1390 254 1600 454" stroke="#93c5fd" strokeWidth="1.8" opacity="0.75" />
      </svg>

      <div className="relative mx-auto flex max-w-[1536px] flex-col items-center text-center">
        ...
        <p className="max-w-3xl text-base font-medium italic leading-relaxed text-blue-200/85 md:text-lg">
          {hero.description}
        </p>
      </div>
...
export default StudentsInternshipsHeroSection
