function AutofinancedFieldSection({ section }) {
    ...
    <section className="relative overflow-hidden border-t border-slate-200 bg-white py-24 px-6 md:px-12">
      ...
      <div className="relative z-10 mx-auto max-w-[1536px]">
        ...
        <div className="grid gap-16 lg:grid-cols-2">
          <div>
            <h4 className="mb-8 border-b border-slate-100 pb-4 text-sm sm:text-base md:text-lg font-black uppercase tracking-[0.4em] text-[#00447e]">Sectores de inserción</h4>
          ...
          <div>
            ...
            <div className="space-y-4">
              {section.roles.map((role) => (
                <div key={role.role} className="flex items-center gap-4 group">
...
export default AutofinancedFieldSection
