function AutofinancedHeroSection({ hero }) {
  ...
  return (
    <section className="relative overflow-hidden border-b-8 border-[#ea580c] bg-[linear-gradient(160deg,#001d3d_0%,#003666_55%,#00447e_100%)] pt-[112px] pb-24 px-8">
      ...
      <svg className="pointer-events-none absolute right-0 top-0 h-[360px] w-[900px] opacity-[0.18]" viewBox="0 0 900 360" fill="none" aria-hidden="true">
...
export default AutofinancedHeroSection
